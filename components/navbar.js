...
<div>
    <ul id="categories">
        ...
        <li class="categories-items">FEATURED
            <div class="submenu">
                <ul>
                    <li><a href="./project by Anurag/featured.html">Special Offers</a></li>
                    <li><a href="./project by Anurag/self care essential.html">New Total RF Serum</a></li>
                    <li><a href="./project by Anurag/self care essential.html">Spotless for Teens</a></li>
                    <li><a href="./project by Anurag/spotless for teens.html">Self Care Essentials</a></li>
                </ul>
            </div>
        </li>
    ...
    <div id="searchDiv">
        <div>
            <div id="inputField">
                <input type="text" placeholder="" id="query"><span><button id="Cross-button">x</button></span>
